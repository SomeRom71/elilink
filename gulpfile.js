...
gulp.task('browser-sync', ['sass', 'jade', 'scripts', 'images', 'fonts', 'plugins'], () => {
  browserSync.init({
    server: {
...
gulp.task('plugins', () => {
  gulp.src(paths.plugins.src)
    .pipe(gulp.dest(paths.plugins.dist));
});


// Complete build sequence
gulp.task('build', ['sass', 'jade', 'scripts', 'images', 'fonts', 'plugins']);
